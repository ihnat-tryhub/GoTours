  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      function s(e) {
        var t;
        return (t =
          'undefined' != typeof ArrayBuffer && ArrayBuffer.isView ? ArrayBuffer.isView(e) : e && e.buffer && e.buffer instanceof ArrayBuffer);
      }
      function u(e) {
      ...
      function g() {
        return (
          ('undefined' == typeof navigator || 'ReactNative' !== navigator.product) && 'undefined' != typeof window && 'undefined' != typeof document
        );
      }
      function v(e, t) {
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        return t(e).then(
          ...
          function (t) {
            return (
              s(t) || (r(e), t && t.response && (t.response.data = i(t.response.data, t.response.headers, e.transformResponse))), Promise.reject(t)
            );
          },
        );
      };
